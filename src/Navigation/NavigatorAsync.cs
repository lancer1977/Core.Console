...
namespace PolyhydraGames.Core.Console.Navigation;

public partial class NavigatorAsync : INavigatorAsync
{
    private readonly IStatusBarManager _statusBarManager;
    private readonly IApp _app;
    private readonly IViewFactoryAsync _viewFactory;

    public NavigatorAsync(IViewFactoryAsync viewFactory, IStatusBarManager statusBarManager, IApp app)
    {
    ...
    private INavigation Navigation => _app.Navigation;
